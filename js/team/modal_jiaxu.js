...
(function() {
    /**terms**/
    var persons=[
       {name:"LIU JIAXIU / DIGITAL MARKETING MANAGER ",profile:"She is a visual and animation designer. His strength lies in his ability to use his multidisciplinary skills in interaction design, 3D animation and user interface to create purposeful and aesthetically pleasing designs/experiences to help local companies create their brands."},
     ];
   var myModal = {};
   
   myModal.modal = document.getElementById("myModal");
  
   myModal.triggerBtn = document.getElementById("trigger_jiaxiu");
